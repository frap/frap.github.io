...
#+JEKYLL_LAYOUT: post
#+JEKYLL_CATEGORIES: [orgmode, octopress]
#+JEKYLL_PUBLISHED: true

I have recently just started re-blogging again. I used markdown previoulsy to store note and am at present reformatting them to be compatible with this blog. I have decided on using [[http:octopress.org][Octopress]]
...
2. It relies on Yoshinari orglue org-mode setip as well as ctables
